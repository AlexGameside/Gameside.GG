...
const NewBankWithdrawModal = (props) => {
  // variables
  const {
    open,
    onClose,
        ...
        >
          <Grid item sx={{ width: "100%" }}>
            ...
            >
              ...
              <Grid item>
                <Typography sx={styles.bankType}>Bank</Typography>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid item sx={{ width: "100%" }}>
            ...
            >
              <Grid item>
                <Typography sx={styles.typeLabel}>Sending Email to:</Typography>
              </Grid>
              <Grid item>
                <Typography sx={styles.bankType}>{sendTo}</Typography>
              </Grid>
            </Grid>
          </Grid>
            ...
            >
              ...
              <Grid item>
                <Typography sx={styles.withdrawAmount}>
                  {numFormatter.format(parseFloat(withdrawAmount * 0.95 - 1))}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
          ...
          <Grid item sx={{ width: "100%" }}>
            ...
            >
              <Grid item>
                <Typography sx={styles.typeLabel}>Currency:</Typography>
              </Grid>
              <Grid item>
...
export default NewBankWithdrawModal;
