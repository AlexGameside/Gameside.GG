...
const HomeSignupLoginModal = (props) => {
  // variables
    ...
    <>
      <Dialog open={open} onClose={onClose} PaperProps={{ style: styles.card }}>
        ...
        <DialogTitle sx={styles.title}>
          <img src={whiteLogo} style={{ width: 100 }} />
          {handleClose ? (
            <IconButton
              aria-label="close"
              onClick={handleClose}
        ...
        {showSignup ? (
          <NewSignupModalContent showLogin={handleShowLogin} />
        ) : null}
        {showForgot ? (
          <NewForgotModalContent showLogin={handleShowLogin} />
        ) : null}
        {showReset ? (
          <NewResetPassModalContent showLogin={handleShowLogin} />
        ) : null}
      </Dialog>
    </>
  );
...
export default HomeSignupLoginModal;
