...
import CashMatchHistoryItem from "./CashMatchHistoryItem";

const CashMatchHistoryList = (props) => {
  const { matches } = props;
  ...
  if (matches?.length < 1) {
    return (
      <Grid item alignSelf="center">
        ...
        >
          <Grid item>
            <FaPiggyBank style={{ fontSize: 40, color: theme.metaText() }} />
          </Grid>
          ...
          <Grid item>
            ...
            >
              Compete in a Cash Match and they will appear here.
            </Typography>
          </Grid>
        </Grid>
      </Grid>
                ...
                <Grid item sx={{ width: "100%" }}>
                  ...
                  >
                    {section[1]?.map((scrim, i) => {
                      return (
                        <>
                          <CashMatchHistoryItem key={i} scrim={scrim} />
                          <Grid item sx={{ width: "100%" }}>
...
export default CashMatchHistoryList;
