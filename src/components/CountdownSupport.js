            ...
            >
              ...
              >
                <MatchTabButton
                  ...
                  onClick={() => navigate("/countdown/support/contact")}
                />

                <MatchTabButton
                  label="FAQ"
                  selected={selected === "FAQ"}
                  onClick={() => navigate("/countdown/support/FAQ")}
                />

                <MatchTabButton
                  label="Rules"
                  selected={selected == "rules"}
                  onClick={() => navigate("/countdown/support/rules")}
                />

                <MatchTabButton
                  label="Terms of Service"
                  selected={selected == "tos"}
                  onClick={() => navigate("/countdown/support/tos")}
                />

                <MatchTabButton
                  label="Privacy Policy"
                  selected={selected == "privacy-policy"}
                  onClick={() => navigate("/countdown/support/privacy-policy")}
                />
              </Grid>
            </Grid>
          </Grid>
...
export default CountdownSupport;